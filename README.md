...
- **Complex Conjugation**: By feeding conj(h0[-k]) into the time-step equation alongside h0[k], we mathematically guarantee that when the imaginary frequencies are collapsed by the IDFT, the resulting physical height data is strictly real (no floating-point phasing errors).
